...
#include "cairo-dock-class-icon-manager.h"   // GLDI_OBJECT_IS_CLASS_ICON
#include "cairo-dock-log.h"
#include "cairo-dock-dock-manager.h"         // ‘CAIRO_DOCK_IS_DOCK’
#include "cairo-dock-keybinder.h"            // cairo_dock_trigger_shortkey
#include "cairo-dock-animations.h"           // gldi_icon_request_animation
#include "cairo-dock-class-manager.h"        // cairo_dock_get_prev_next_classmate_icon
#include "cairo-dock-windows-manager.h"      // pAppli
